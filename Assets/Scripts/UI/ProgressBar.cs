...
public class ProgressBar : MonoBehaviour
{
    ...
    [SerializeField] [Range(0.1f, 1f)] float maxAlphaValue = 1f;
    ...
    IEnumerator GlowStart()
    {
        ...
        while (!Mathf.Approximately(c.a, maxAlphaValue))
        {
            c.a = Mathf.SmoothDamp(c.a, maxAlphaValue, ref velocity, speed);
            glow.color = c;
            speed -= 0.01f;
            yield return null;
        }
